...
pkg_setup() {
	ewarn "In case of build failure try compiling with MAKEOPTS=\"-j1\""

	if use projectm; then
		ewarn "projectm visualizations are known to be broken:"
		ewarn "http://code.google.com/p/clementine-player/issues/detail?id=442"
	fi
}
