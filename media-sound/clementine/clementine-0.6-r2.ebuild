...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="ayatana +dbus +devicekit iphone ipod +lastfm mtp projectm wiimote"
IUSE+="${LANGS// / linguas_}"
...
PATCHES=(
	"${FILESDIR}"/${P}-optional-liblastfm.patch
	"${FILESDIR}"/${P}-optional-dbus-devicekit.patch
)
...
src_configure() {
	...
	mycmakeargs=(
		...
		$(cmake-utils_use devicekit ENABLE_DEVICEKIT)
