...
IUSE="+a52 +alsa aqua bindist bluray bs2b +bzip2 cddb +cdio cpudetection
debug directfb doc +dts +dv dvb +dvd +dvdnav +enca +faad fbcon ftp gif ggi
gsm +iconv ipv6 jack joystick jpeg jpeg2k kernel_linux ladspa lcms +libass
libcaca lirc mad md5sum mng +mp3 +network nut amr +opengl oss png pnm
portaudio +postproc pulseaudio pvr +quicktime quvi radio +rar +real +rtc rtmp
samba +schroedinger sdl +speex tga +theora threads +unicode v4l vcd vdpau
+vorbis vpx win32codecs +X xanim xinerama +xscreensaver +xv xvid yuv4mpeg
"
IUSE+=" symlink"
