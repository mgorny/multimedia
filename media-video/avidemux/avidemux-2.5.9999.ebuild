...
MY_P=${PN}_2.5_branch_gruntster

DESCRIPTION="Video editor designed for simple cutting, filtering and encoding tasks"
HOMEPAGE="http://fixounet.free.fr/avidemux"
ESVN_REPO_URI="svn://svn.berlios.de/avidemux/branches/${MY_P}"
...
PATCHES=( "${FILESDIR}/2.5-i18n.patch"
	"${FILESDIR}/2.5-coreImage-parallel-build.patch"
	"${FILESDIR}/2.5-build-plugins-fix.patch" )
